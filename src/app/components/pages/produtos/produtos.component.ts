...
const ELEMENT_DATA: ProdutoElement[] = [
  ...
  {produto: 'Perfume Dog Femea', fornecedor: 'Pet Clean', preco: 'R$ 18,00', investimento: 'R$ 9,00', qtd: '25'},
  {produto: 'Coleira', fornecedor: 'Mesh Reserva', preco: 'R$ 149,90', investimento: 'R$ 74,00', qtd: '12'},
  {produto: 'Ração', fornecedor: 'Special Dog', preco: 'R$ 249,90', investimento: 'R$ 74,00', qtd: '18'},
  {produto: 'Brinquedo Osso', fornecedor: 'Genérico', preco: 'R$ 1,90', investimento: 'R$ 0,50', qtd: '9'},
